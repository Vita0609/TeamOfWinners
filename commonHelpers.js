...
`;function S(){const t=document.querySelector(".swiper-wrapper"),o=j.map(i=>`
      <li class="swiper-slide">
        ${h(i)}
      </li>
    `).join("");t.innerHTML=o}function b(){new g(".swiper-container",{modules:[f,v],slidesPerView:1,spaceBetween:100,navigation:{nextEl:".project-btn-right",prevEl:".project-btn-left"}})}document.addEventListener("DOMContentLoaded",()=>{S(),b()});const a=document.querySelector(".reviews-section");if(a){let i=function(e){return e.map(r=>`
  ...
  `).join("")};const t=a.querySelector(".reviews-cards");a.querySelector(".reviews-btn-prev"),a.querySelector(".reviews-btn-next");async function o(e){const y="https://portfolio-js.b.goit.study/api"+"/reviews";try{return(await fetch(y)).json()}catch(m){return console.log(m),u.error({position:"topRight",message:"Not Found"}),[]}}async function l(){try{const e=await o();if(e.length>0){const r=i(e);t.insertAdjacentHTML("beforeend",r);const n=new g(a.querySelector(".swiper"),{modules:[f,w],breakpoints:{320:{slidesPerView:1,loop:!1},768:{slidesPerView:2,spaceBetween:16,loop:!1},1440:{slidesPerView:4,spaceBetween:16,loop:!1}},autoplay:{delay:3e3,disableOnInteraction:!0,pauseOnMouseEnter:!0},keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!0},navigation:{nextEl:".project-btn-left",prevEl:".project-btn-right"}})}else console.log("No reviews to display")}catch(e){console.log(e),u.error({position:"topRight",message:"Failed to load reviews"})}}l()}const x=document.querySelector(".header-menu-link"),s=document.querySelector(".header-menu-list"),L=document.querySelector(".burger-btn"),c=document.querySelector(".burger-menu"),_=document.querySelector(".close-btn"),E=document.querySelector(".burger-order-btn"),T=document.querySelector(".burger-menu-list"),M=window.matchMedia("(min-width: 768px)");x.addEventListener("click",d);L.addEventListener("click",I);_.addEventListener("click",p);s.addEventListener("click",d);E.addEventListener("click",p);T.addEventListener("click",p);M.addEventListener("change",N);document.body.addEventListener("click",t=>{!s.classList.contains("visually-hidden")&&!t.target.classList.contains("header-menu-link")&&d()});document.addEventListener("keydown",t=>{t.key==="Escape"&&!s.classList.contains("visually-hidden")&&d()});const A=new KeyframeEffect(s,[{opacity:"0"},{opacity:"1"}],{duration:240,easing:"ease-in-out"}),O=new KeyframeEffect(s,[{opacity:"1"},{opacity:"0"}],{duration:240,easing:"ease-in-out"}),P=new Animation(A,document.timeline),D=new Animation(O,document.timeline),$=new KeyframeEffect(c,[{transform:"translateX(100%)"},{transform:"translateX(0)"}],{duration:150}),q=new KeyframeEffect(c,[{transform:"translateX(0)"},{transform:"translateX(100%)"}],{duration:150}),k=new Animation($,document.timeline),B=new Animation(q,document.timeline);function d(){if(s.classList.contains("visually-hidden")){P.play(),s.classList.remove("visually-hidden");return}D.play(),setTimeout(()=>{s.classList.add("visually-hidden")},150)}function I(){c.classList.add("is-open"),k.play(),document.body.style.overflow="hidden"}function p(){B.play(),setTimeout(()=>{c.classList.remove("is-open")},150),document.body.style.overflow=""}function N(t){t.matches&&c.classList.contains("is-open")&&p()}
